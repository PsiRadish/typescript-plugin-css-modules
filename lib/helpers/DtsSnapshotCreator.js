...
exports.getFileType = function(fileName) {
  if (fileName.endsWith('.css')) return 'css' /* css */;
  if (fileName.endsWith('.less')) return 'less' /* less */;
  return 'scss' /* scss */;
};
...
var DtsSnapshotCreator = /** @class */ (function() {
  ...
  DtsSnapshotCreator.prototype.createExports = function(classes, options) {
    ...
    var isReservedWord = function(className) {
      return !reserved.check(className);
    };
  ...
  DtsSnapshotCreator.prototype.getDtsSnapshot = function(
    ts,
    processor,
    fileName,
    scriptSnapshot,
